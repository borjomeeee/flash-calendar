...
declare const CalendarItemDayContainer: ({ children, isStartOfWeek, shouldShowActiveDayFiller, shouldShowSpecialDateDot, theme, daySpacing, dayHeight, stay, }: CalendarItemDayContainerProps) => react_jsx_runtime.JSX.Element;
